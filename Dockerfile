...
RUN apt-get update && apt-get -qq -y install python-pip python-dev libffi-dev python-cairo cassandra oracle-java8-installer oracle-java8-set-default supervisor && apt-get clean && rm -rf /var/cache/apt
